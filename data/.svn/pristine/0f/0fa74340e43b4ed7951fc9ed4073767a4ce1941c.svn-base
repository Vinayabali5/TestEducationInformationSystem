...
/**
 * QStudentAttendanceByCourseGroupForPeriod is a Querydsl query type for
 * StudentAttendanceByCourseGroupForPeriod
 */
@Generated("com.querydsl.codegen.EntitySerializer")
public class QStudentAttendanceByCourseGroupForPeriod extends EntityPathBase<StudentAttendanceByCourseGroupForPeriod> {
    
    private static final long serialVersionUID = 2047941701L;
    
    private static final PathInits INITS = PathInits.DIRECT2;
    
    public static final QStudentAttendanceByCourseGroupForPeriod studentAttendanceByCourseGroupForPeriod = new QStudentAttendanceByCourseGroupForPeriod("studentAttendanceByCourseGroupForPeriod");
    ...
    public QStudentAttendanceByCourseGroupForPeriod(
        String variable) {
        this(StudentAttendanceByCourseGroupForPeriod.class, forVariable(variable), INITS);
    }
    
    public QStudentAttendanceByCourseGroupForPeriod(
        Path<? extends StudentAttendanceByCourseGroupForPeriod> path) {
    ...
    public QStudentAttendanceByCourseGroupForPeriod(
        PathMetadata metadata,
        PathInits inits) {
        this(StudentAttendanceByCourseGroupForPeriod.class, metadata, inits);
    }
    
    public QStudentAttendanceByCourseGroupForPeriod(
        Class<? extends StudentAttendanceByCourseGroupForPeriod> type,
        PathMetadata metadata,
        PathInits inits) {
