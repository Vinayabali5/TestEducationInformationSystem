...
public class ContactDto implements Serializable{
    ...
    /**
     * This method is used to return the ContactType Description for the Contact object
     *
     * @return the ContactType Description for the Contact object
     */
    ...
    /**
     * This method is used to return the Title Description for the Contact object
     *
     * @return the Title Description for the Contact object
     */
    @JsonProperty(value = "_titleDescription")
    public String get_TitleDescription() {
        return this.contact != null & this.contact.title != null ? this.contact.title.description : null
    }
    
    /**
     * This method is used to return the Gender Code for the Contact object
     *
     * @return the Gender Code for the Contact object
     */
    @JsonProperty(value = "_genderCode")
    public String get_GenderCode() {
        return this.contact != null & this.contact.gender != null ? this.contact.gender.code : null
    }
}
