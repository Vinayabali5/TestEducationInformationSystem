...
class EnrolmentSummaryDto implements Serializable {
     ...
     */
    EnrolmentSummaryDto(Enrolment enrolment) {
        ...
        this.reference = enrolment.reference != null ? PreReferenceDto.mapFromEntity(enrolment.reference) : null;
    }
     ...
     */
    public static EnrolmentSummaryDto mapFromEntity(Enrolment enrolment){
        return new EnrolmentSummaryDto(enrolment)
    }
     ...
     */
    public static List<EnrolmentSummaryDto> mapFromList(List<Enrolment> enrolmentList) {
        return enrolmentList.collect { enrolment ->  new EnrolmentSummaryDto(enrolment) };
    }
