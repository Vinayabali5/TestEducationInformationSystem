...
public class EnrolmentDtoTest {
    ...
    public void testConstructor_NullStudent() {
        EnrolmentDto enrolment = new EnrolmentDto(enrolment3)
    ...
    public void testMapFromEntity(){
        List<EnrolmentDto> enrolmentTest = EnrolmentDto.mapFromList( enrolments )
    ...
    public void testMethod_Get_NullCourseReference() {
        Enrolment enrolment = new Enrolment(id: 1, student: createStudent(), year : createAcademicYear(), course: null)
        EnrolmentDto enrolmentDto1 = new EnrolmentDto(enrolment)
    ...
    public void testMethod_Get_NullAcademicYearCode() {
        EnrolmentDto enrolmentDto1 = new EnrolmentDto(enrolment3)
